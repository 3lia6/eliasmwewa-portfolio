      ...
      >
        ...
        <div className="z-10">
          ...
          <div className='socials flex flex-row gap-2 mb-2'>
                <Link href='https://linkedin.com/in/elias-mwewa-691b061b0/' passHref>
                  <Image src='/linkedin.svg' alt='Linkedin Icon' width={30} height={30} />
                </Link>
                <Link href='https://github.com/3lia6' passHref>
                  <Image src='/github.svg' alt='Github Icon' width={30} height={30} />
                </Link>
                <Link href='https://web.facebook.com/profile.php?id=100074595219096' passHref>
                  <Image src='/facebook.svg' alt='Facebook Icon' width={30} height={30} />
                </Link>
                <Link href='https://www.instagram.com/eliasmwewah/' passHref>
                  <Image src='/instagram.svg' alt='Instagram Icon' width={30} height={30} />
                </Link>
                <Link href='https://tiktok.com/@trendingzambia?lang=en' passHref>
                  <Image src='/tiktok.svg' alt='TikTok Icon' width={30} height={30} />
                </Link>
            </div>
        </div>
        <div>
